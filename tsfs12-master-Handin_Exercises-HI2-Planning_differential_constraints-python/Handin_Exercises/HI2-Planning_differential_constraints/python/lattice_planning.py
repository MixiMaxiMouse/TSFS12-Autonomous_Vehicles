...
# YOUR CODE HERE
# Couleurs pour les segments forward/reverse
forward_color = "b"
reverse_color = "r"

for i, r in enumerate(res):
    # Obtenir le chemin pour ce planner
    p, sp = mp.plan_to_path(start, r)

    # Créer une nouvelle figure pour ce planner
    ...
    # Tracer le chemin segment par segment
